byte NESData = 4;       // this is the pin that the Data connection is connected to
byte NESLatch = 2;         // this is the pin that the Latch (otherwise known as strobe) connection is connected to
byte NESClock = 3;         // this is the pin that the Clock connection is connected to
